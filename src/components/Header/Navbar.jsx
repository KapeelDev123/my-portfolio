...
const Navbar = () => {
  ...
  return (
    <div className="py-5 text-lg font-medium flex items-center justify-between shadow-lg sticky top-0 bg-white z-10">
      <a className="hover:text-blue-600" href="/">
        {' '}
        <h1 className="ml-10 text-2xl font-bold">Kapeel Dev</h1>
      </a>
      {toggleNav ? (
